...
public final class PredictionNode implements Serializable, Cloneable,
   ...
   * @param adTree the tree that this node belongs to
   */
  public final void addChild(Splitter newChild, ADTree adTree) {
    ...
    if (oldEqual == null) { // didn't find one so just add
      ...
      setOrderAddedSubtree(addChild, adTree);
